...
OUTPUT:
{
  ...
  "usr2func": [{
      ...
      "bases": [],
      "vars": [7892962471424670909, 17130001153697799035, 16879535361702603834, 10198518325066875844, 14555488990109936920, 10963664335057337329],
      "callees": [],
      "kind": 12,
      "parent_kind": 1,
      "storage": 0,
  ...
  "usr2type": [{
      ...
      "declarations": [],
      "derived": [],
      "instances": [7892962471424670909, 17130001153697799035, 16879535361702603834, 10198518325066875844, 14555488990109936920, 10963664335057337329],
      "uses": []
    }],
  "usr2var": [{
